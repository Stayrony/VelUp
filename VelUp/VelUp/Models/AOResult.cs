...
namespace VelUp.Models
{
    ...
    public class AOResult
    {
        ...
        public AOResult([CallerMemberNameAttribute]string callerName = null, [CallerFilePath]string callerFile = null, [CallerLineNumber]int callerLineNumber = 0)
        {
